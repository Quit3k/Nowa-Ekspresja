...
// --- KOMPONENT ---
// Przyjmujemy obiekt `data` jako props
    ...
    <section className="min-h-screen flex items-center pt-20 pb-10 lg:py-20 bg-white">
      <div className="w-full max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          {/* LEWA STRONA: OPIS ARTYSTY (DANE DYNAMICZNE) */}
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-10">
              <button
                // onClick={() => scrollToSection('wywiady')} // TĄ LOGIKĘ DODAMY PÓŹNIEJ
              ...
              <button
                // onClick={() => scrollToSection('galeria')} // TĄ LOGIKĘ DODAMY PÓŹNIEJ
          ...
          {/* PRAWA STRONA: OBRAZ (DANE DYNAMICZNE) */}
